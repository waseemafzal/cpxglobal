...
<section id="main_content">
    ...
    <div class="container">
        ...
        <ol class="breadcrumb"><li><a rel="v:url" property="v:title" href="">Home</a></li><li class="active"> Press Release</li></ol>
        <div class="row">
	...
	<div id="search-2" class="widget widget_search">
		...
		</div><div id="recentpost_widget-2" class="widget widget_recentpost_widget"><h4 class="widget_title">Recent News</h4>
    <ul>
...
if (strlen($post_description) > 10)
   echo substr($post_description, 0, 150) . '...';		
		?></p>
    <a href="press_release/detail/<?=$row->id;?>" class="btnCustom ">Read more</a>
  </div>
</div>
<!-- end post -->
<div class="clearfix">&nbsp;</div>
