...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li > <a href="sidebarcontent?cms_id=<?php echo (isset($_GET['cms_id']) ? $_GET['cms_id'] :'');?>">View Content </a></li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
             ...
             <div class="col-xs-12"><div class="alert hidden"></div></div>
                  ...
                  <?php
                   if(isset($_GET['cms_id']) and !empty($_GET['cms_id']))
				   {
					
					echo '<input   type="hidden"  value="'.$_GET['cms_id'].'" name="cms_id">';   
				   }
...
<input  class="form-control" id="title"  placeholder="Title" value="<?php if(isset($row)){ echo $row->title;} ?>" name="title">
				...
				<input  class="form-control" id="title"  placeholder="URL" value="<?php if(isset($row)){ echo $row->url;} ?>" name="url">
                    </div>
                     <!-- <div class="col-xs-12 col-md-6">
...
$.ajax({
  ...
  /**********************************save************************************/
	...
	// ajax start
		    $.ajax({
			type: "POST",
			url: "<?php echo base_url().'sidebarcontent/save'; ?>",
			data: formData,
			cache: false,
			contentType: false,
			processData: false,
