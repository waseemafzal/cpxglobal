...
class Sidebarcontent extends MX_Controller {
	...
	public $view = "view";
	public $tbl = 'tbl_sidebarcontent';
	
	public function index(){  

		 $cms_id = (isset($_GET['cms_id']) ? $_GET['cms_id'] :'');
		
		$aData['data'] =$this->db->select('*')->from($this->tbl)->where('cms_id',$cms_id)->order_by("id","desc")->get();
