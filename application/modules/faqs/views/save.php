            ...
            <div class="box-body">
             ...
             <div class="col-xs-12"><div class="alert hidden"></div></div>
                    ...
                    <div class="col-xs-12 col-md-12">
                      <label > Answer</label>
<textarea class="form-control" rows="10" name="answer"><?php if(isset($row)){ echo $row->answer;} ?>Lorem ipsum answer</textarea>
                    </div>
  ...
  /**********************************save************************************/
	...
	// ajax start
		    $.ajax({
			type: "POST",
			url: "<?php echo base_url().'faqs/save'; ?>",
			data: formData,
			cache: false,
			contentType: false,
			processData: false,
