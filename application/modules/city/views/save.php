...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li > <a href="cat">View cities </a></li>
      </ol>
    </section>
             ...
             <div class="col-xs-12"><div class="alert hidden"></div></div>
                    ...
                    <div class="col-xs-12 col-md-6">
                      <label for="exampleInputEmail1"> City name</label>
                        <input type="text" class="form-control" id="cat_name"  placeholder="London" name="cat_name" value="<?php if(isset($row)){ echo $row->cat_name;} ?>">
