...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li > <a href="post/add" class="btn btn-sm btn-su">Add Post</a></li>
      </ol>
    </section>
    <!-- Main content -->
...
<?php } ?>
        ...
        <td class="center">
            <a data-toggle="tooltip" title=" <?php echo ucwords(this_lang('Edit'));?>" class="btn btn-info" href="post/edit/<?php echo $row->id;?>">
                <i class="glyphicon glyphicon-edit icon-white"></i>
                Edit
            </a>
            <a data-toggle="tooltip" title=" <?php echo ucwords(this_lang('Delete'));?>" class="btn btn-danger" href="javascript:void(0)" onClick="deleteRecord('<?php echo$row->id;?>','post');">
