...
class Disputedorder extends MX_Controller {
	...
	public function getCash(){  
		...
		$aData['data'] =get_by_where_array(array('payment_type'=>'cash'),'order');
...
$data = get_by_where_array(array('order_id'=>$_POST['id']),'order_card_detail');
...
//`card_num`, `card_cvc`, `card_exp_month`, `card_exp_year`, `item_price_currency`, `paid_amount`, `paid_amount_currency`, `txn_id`, `payment_status`



$html.='<tr><th>card_num</th><td>'.$card->card_num.'</td></tr>';

$html.='<tr><th>card_cvc</th><td>'.$card->card_cvc.'</td></tr>';

$html.='<tr><th>exp_month</th><td>'.$card->card_exp_month.'</td></tr>';

$html.='<tr><th>exp_year</th><td>'.$card->card_exp_year.'</td></tr>';

$html.='<tr><th>currency</th><td>'.$card->item_price_currency.'</td></tr>';

$html.='<tr><th>paid_amount</th><td>'.$card->paid_amount.'</td></tr>';

$html.='<tr><th>paid_amount_currency</th><td>'.$card->paid_amount_currency.'</td></tr>';

$html.='<tr><th>txn_id</th><td>'.$card->txn_id.'</td></tr>';

$html.='<tr><th>payment_status</th><td>'.$card->payment_status.'</td></tr>';
...
$query="SELECT s.id as sellerID,s.name as sellerName,s.email as sellerEmail,s.address as sellerAddress,s.phone as sellerPhone,s.image as sellerImage,
