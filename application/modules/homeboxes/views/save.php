...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li > <a href="homeboxes">View Homeboxes </a></li>
      </ol>
    </section>
...
<input  class="form-control " id="url" autocomplete="off"  placeholder="www.publisher.com" value="<?php if(isset($row)){ echo $row->url;} ?>" name="url">
      ...
      <br>
                    <?php if(isset($row)){ 
				   echo '<img src="'.base_url().'uploads/'.$row->image.'" width="150">';
				   }?>
                   </div>
                     <div class="clearfix">&nbsp;</div>
                     <div class="clearfix">&nbsp;</div>
...
$.ajax({
  ...
  /**********************************save************************************/
	...
	// ajax start
		    $.ajax({
			type: "POST",
			url: "<?php echo base_url().'homeboxes/save'; ?>",
			data: formData,
			cache: false,
			contentType: false,
			processData: false,
