...
class Blogpost_comments extends MX_Controller {
	...
	public $view = "view";
	public $tbl = 'blogpost_comments';
	
	public function index($id=''){  
$query =$this->crud->edit($id,'blogpost');
$aData['blogTitle'] =$query->post_title;
		$aData['data'] =$this->db->query("SELECT p.* FROM ".$this->tbl." p where p.blog_id='".$id."'");
