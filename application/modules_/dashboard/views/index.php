 ...
 <h3><?php echo  count_tbl_where('order','watched',0); ?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-blueviolet">
            ...
            <a href="view_users?usertype=buyer" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-burlywood">

            <div class="inner">

              <h3><?php echo  $freelancer_count; ?></h3>
            ...
            <a href="view_users?usertype=freelancers" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aquamarine">
            ...
            <div class="inner">
              ...
              <h3><?php echo  $total_active_service; ?></h3>
